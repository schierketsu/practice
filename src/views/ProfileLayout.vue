  ...
  <div class="max-w-screen-2xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-10">
    ...
    <nav v-if="auth.isAdmin" class="flex flex-wrap gap-2 mb-6 -mx-1 px-1 sm:mx-0 sm:px-0">
      <router-link
        ...
        :key="l.to"
        :to="l.to"
        class="px-3 py-2 sm:px-4 rounded-lg border-2 border-gray-200 dark:border-gray-600 text-xs sm:text-sm font-medium text-gray-900 dark:text-white hover:border-[#212121] dark:hover:border-gray-300 min-h-[44px] inline-flex items-center"
...
const adminLinks = [
  ...
  { to: '/профиль/вузы', label: 'Вузы' },
  { to: '/профиль/технологии', label: 'Технологии' },
