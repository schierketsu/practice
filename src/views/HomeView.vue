  ...
  <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8 w-full pb-4 sm:pb-8">
    <div class="relative">
      ...
      <div v-else class="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-6">
        ...
        <div class="w-full lg:w-1/3 flex-shrink-0 overflow-y-auto flex flex-col gap-4">
          <LocationFilters />
        ...
        <div class="w-full lg:flex-1 flex-shrink-0 h-[calc(100vh-380px)] sm:h-[calc(100vh-360px)] lg:h-[calc(100vh-200px)] min-h-[400px] sm:min-h-[450px] lg:min-h-[500px] max-h-[calc(100vh-380px)] sm:max-h-[calc(100vh-360px)] lg:max-h-none overflow-hidden relative">
          <OrganizationMap />
...
/* Убеждаемся, что контейнер карты имеет правильное позиционирование */
